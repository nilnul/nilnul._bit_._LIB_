...
namespace nilnul.bit._theorem._proposal._statement_
{
	...
	/// 
	/// We will reserve the name of Axiom for a higher-order sense; in that order/layer, axiom is used to prove some basic theorems.  and theorem is used to prove other theorems. So that's a theorem calculus, where axiom is used.
	/// </remarks>

	public interface PostulateI
	{
		...
		/// </summary>
		nilnul.bit.expr.Set1 postulate { get; }
	}
}
