...
namespace nilnul.bit.op.set.be_.complete_.byCompoFunc_.ofVec_
{
	/// <summary>
	...
	public class ProjectionIni
	{
		...
		public ProjectionIni(IEnumerable<bit.OpI2> ops)
		{
			this.ops = ops.ToArray();
		}

		public ProjectionIni(params nilnul.bit.OpI2[] singleton1)
		{
