...
namespace nilnul.bit.expr.be_
{
		...
		/*obj::*/nilnul.obj.BeI1<nilnul.bit.ExprI1>
	{
		static public bool Eval(nilnul.bit.ExprI1 expr)
		{
			...
			return Eval(
				expr.substitute(firstVar, bit.expr_.call_.No.CreateNil())
			)
			&&
			Eval(
				expr.substitute(firstVar, bit.expr_.call_.No.CreateOne())
			);
		...
		[Obsolete( nameof( be_.tauto.vow.Ed))]
		public class En :nilnul.obj.be.En_beDefaultable<ExprI1, Tauto>
		{
